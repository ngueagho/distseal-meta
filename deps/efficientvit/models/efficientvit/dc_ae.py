...
from deps.efficientvit.models.nn.act import build_act
from deps.efficientvit.models.nn.norm import build_norm
from deps.efficientvit.models.nn.ops import (
...
class DCAE(nn.Module):
    ...
    def forward_old(self, x: torch.Tensor, global_step: int) -> torch.Tensor:
        x = self.encoder(x)
        x = self.decoder(x)
